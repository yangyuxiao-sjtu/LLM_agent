...
class LLMHlsmSubgoalModel(ActionProposal, LearnableModel):
    ...
    def get_state(self) -> "LLMHlsmSubgoalModel.ModelState":
        return self.model_state

    def set_state(self, state: "LLMHlsmSubgoalModel.ModelState"):
        self.model_state = state

    def reset_state(self):
        self.model_state = LLMHlsmSubgoalModel.ModelState()
        self.trace = {
            "subgoal": None
        }
    ...
    def mle(self,
            ...
            task: HlsmTaskRepr,
            model_state: "LLMHlsmSubgoalModel.ModelState"):
    ...
    def forward_inference(self,
        ...
        print('state data device:::',device)
        ...
        task_emb = self._forward_model(states, tasks, action_labels, batch_id)
